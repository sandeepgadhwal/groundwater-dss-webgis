...
def to_rgb(bandarray):
    ...
    print(maxvalue,minvalue, bandarray)
    bandarray = (bandarray/maxvalue) * 100
    # Colour the red band
...
def calculatedr(timenow, DW, DF_name, RW, RF_name, AW, AF_name, SW, SF_name, TW, TF_name, IW, IF_name, CW, CF_name, UW, UF_name):
    ...
    print (divisor)
    CALC_ba = (DF_ba * DW + RF_ba * RW + AF_ba * AW + SF_ba * SW + TF_ba * TW + IF_ba * IW + CF_ba*CW + UF_ba*UW) / divisor
    #print(CALC_ba)
